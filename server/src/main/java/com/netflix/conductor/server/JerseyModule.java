...
public final class JerseyModule extends JerseyServletModule {
    ...
    protected void configureServlets() {
		...
		jerseyParams.put(PackagesResourceConfig.PROPERTY_PACKAGES, "com.netflix.conductor.server.resources;com.netflix.conductor.contribs.listener;com.netflix.conductor.contribs.archive;io.swagger.jaxrs.json;io.swagger.jaxrs.listing;");
