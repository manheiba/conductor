...
public interface RedisLockConfiguration extends Configuration {
    ...
    String REDIS_SERVER_PASSWORD = "workflow.redis.locking.server.password";
    String REDIS_SERVER_PASSWORD_DEFAULT_VALUE = "";
    ...
    default String getRedisServerPassword() {
        return getProperty(REDIS_SERVER_PASSWORD, REDIS_SERVER_PASSWORD_DEFAULT_VALUE);
    }
