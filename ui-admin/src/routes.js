...
import Workflow from './components/workflow/executions/AdminWorkflowList';
...
import AdminWorkflowDetails from './components/workflow/executions/AdminWorkflowDetails';
...
const routeConfig = [
  ...
  { path: '/admin/workflow/id/:workflowId', component: AdminWorkflowDetails}
];
